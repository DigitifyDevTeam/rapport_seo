"""Origincbd — automated GMB extract (reference wrapper).

Usage::

    python scripts/clients/origincbd/gmb_ui_extract.py 2026-04
"""
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "origincbd" / month
    ...
    cmd = [
        ...
        "--project-name", "Origin",
        "--business-name", "Origine CBD Paris",
        "--location-name", "originecbd.fr",
        "--profile", str(PROFILE),
        "--no-auto-period",
