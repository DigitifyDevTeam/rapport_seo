/**
 * Digitify — Clarity dashboard capture for a report month.
 *
 *   node scripts/clients/digitify/clarity_ui_extract.js 2026-04
 *   node scripts/clients/digitify/clarity_ui_extract.js 2026-04 --record
 *
...
const outDir = path.join(root, "outputs", "digitify", month);
const session = path.join(root, "outputs", "_sessions", "clarity-digitify.json");
