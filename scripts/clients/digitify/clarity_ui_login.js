/**
 * Digitify — one-time Clarity login (saves agency Microsoft session).
 *
...
const r = spawnSync(process.execPath, [script, "--out", sessionOut, "--profile", profile, "--project-id", "k23l3ye7zj"], {
  cwd: root,
  stdio: "inherit",
});
