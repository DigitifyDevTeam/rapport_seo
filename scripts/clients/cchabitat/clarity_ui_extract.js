/**
 * CC Habitat — Clarity dashboard capture for a report month.
 *
 *   node scripts/clients/cchabitat/clarity_ui_extract.js 2026-04
 *   node scripts/clients/cchabitat/clarity_ui_extract.js 2026-04 --record
 *
 * Project id ivgh9to4z7 (config/clients.yaml, override via .env).
 */
...
const outDir = path.join(root, "outputs", "cchabitat", month);
const session = path.join(root, "outputs", "_sessions", "clarity-cchabitat.json");
