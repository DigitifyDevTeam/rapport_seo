"""CC Habitat — one-time Google Business Profile login.

Usage::

    python scripts/clients/cchabitat/gmb_ui_login.py
"""
...
def main() -> int:
    print("Alias for gmb_ui_prepare.py — use: python scripts/clients/cchabitat/gmb_ui_prepare.py")
    cmd = [
        sys.executable,
        str(SCRIPT),
        "--out", str(SESSION),
